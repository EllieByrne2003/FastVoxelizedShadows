...
$(TARGET): build-subdirs $(OBJS) find-all-objs 
	# echo $(SOURCES)
	@echo -e "\t" CXX $(CXXFLAGS) $(SOURCES) -o $@ -g -O3 -Wunused -lglfw -lGL -lGLEW # TODO Don't like this
	@$(CXX) -o $@ $(SOURCES) $(CXXFLAGS) -g -O3 -Wunused -lglfw -lGL -lGLEW # TODO Don't like this
	# @rm -f $(ALL_OBJS)
	# @mv $(ALL_OBJS) obj
